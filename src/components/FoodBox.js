...
function FoodBox({ foods }) {
  ...
  const [image, setimage] = useState(
    'https://upload.wikimedia.org/wikipedia/commons/4/4d/Wild_turkey_eastern_us.jpg'
  );
    ...
    <div className="container">
      ...
      <div className="columns">
        ...
        <div className="column content">
          ...
          <strong>
            Total calories on the table{' '}
            {diet.reduce((acc, curr) => acc + curr.quantity * curr.calories, 0)}
          </strong>
        </div>
      </div>
    </div>
